...
def main():
    ...
    client_secret = "Etv~O.91n65yU.oLwgok6319W0x1s9qw_p"

    client = onedrivesdk_fork.get_default_client(client_id='7be55caf-706e-4299-bfc3-e15af7f968a9',
...
def rename(client, item_id):
    ...
    renamed_item = onedrivesdk_fork.Item()
...
def paste(client, item_id, copy_item_ids):
    ref = onedrivesdk_fork.ItemReference()
    ref.id = item_id
